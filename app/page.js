...
export default function Home() {
  return (
    <div className="min-h-screen text-white flex flex-col items-center justify-center ">
      <header className="w-full py-6 px-8 flex justify-between items-center border-b backdrop-blur-sm bg-black/75 sticky top-0 z-50 border-black">
        <div className="text-xl font-bold">€uro Careers</div>
        <NavigationMenu className="hidden sm:flex">
          <NavigationMenuList>
            <NavigationMenuItem><a href="#">LIVE Webinar</a></NavigationMenuItem>
            <NavigationMenuItem><a href="#">1-on-1 Coaching</a></NavigationMenuItem>
          </NavigationMenuList>
        </NavigationMenu>
        <Button variant="outline" className="hidden sm:flex items-center gap-2 text-black curosor-pointer">
          <img src="/Whatsapp.svg.webp" alt="WhatsApp Icon" className="w-5 h-5" /> WhatsApp Us</Button>
      </header>
      ...
      <div id="testimonials" className="w-full bg-blue-900 py-16 px-6 text-center text-white">
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8">
          <Card className="bg-gradient-to-br from-purple-800 via-purple-700 to-purple-900 text-white rounded-xl border border-gray-700 shadow-lg">
            <CardContent className="p-6 flex flex-col items-center text-center">
              ...
              <p className="text-white mb-4 text-sm">Thanks to their coaching, I landed a job in Germany within 3 months! The mock interviews and CV feedback were spot on.</p>
              <span className="font-semibold text-white text-sm">— Jane, Software Engineer</span>
            </CardContent>
          </Card>
          <Card className="bg-gradient-to-br from-purple-800 via-purple-700 to-purple-900 text-white rounded-xl border border-gray-700 shadow-lg">
            <CardContent className="p-6 flex flex-col items-center text-center">
              ...
              <p className="text-white mb-4 text-sm">Truly personalized advice. I felt confident applying to jobs across Europe after our sessions.</p>
              <span className="font-semibold text-white text-sm">— John, Marketing Analyst</span>
            </CardContent>
          </Card>
          <Card className="bg-gradient-to-br from-purple-800 via-purple-700 to-purple-900 text-white rounded-xl border border-gray-700 shadow-lg">
            <CardContent className="p-6 flex flex-col items-center text-center">
              ...
              <p className="text-white mb-4 text-sm">The team understands what employers look for. Their tips made my application stand out.</p>
              <span className="font-semibold text-white text-sm">— Harry, UX Designer</span>
            </CardContent>
          </Card>
        </div>
      </div>
